...
class Anonymizer:
    ...
    def none_relative_type(self, log, log2, sensitive_att, cont, l, k, c, dict1, spectime, trace_attributes, life_cycle, all_life_cycle, bk_type, alpha, beta, multiprocess):
        ...
        try:
            violating, dict1 = mvs.mvs(l, k, c, multiprocess)
        except Exception as e:
            sys.exit("If you are using multiprocessing, the main function needs to be indicated! Use (if __name__ == '__main__':)")
    ...
    def relative_type(self, log, sensitive_att, cont, t, l, k, c,dict1,trace_attributes, life_cycle,all_life_cycle,bk_type,alpha, beta, multiprocess):
        repres = ELReps.ELReps(log)
        ...
        mvs = MVS.MVS(traces, logsimple, sensitive_att, cont, sensitives, bk_type, dict_safe= dict1)
        try:
            violating_time, dict1 = mvs.mvs(l, k, c, multiprocess, t)
        except Exception as e:
            sys.exit("If you are using multiprocessing, the main function needs to be indicated! Use (if __name__ == '__main__':)")
